...
\chapter{Transfert de chaleur}
  ...
  \section{Transfert thermique établi}
    ...
    \end{equation}
    où $T_w$ est la température à la paroi, $q_w$ la densité de flux de chaleur à la paroi $q_w = k \frac{dT}{dr}\eval_r=R$ et $D$ la longueur caractéristique (dans le cas d'un conduit, le rayon $R$).
