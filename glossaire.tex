...
\chapter{Glossaire}
  ...
  \begin{align*}
    ...
    \beta &= \hat{\beta}(p,T) = -\frac{1}{\hat{\rho}} \pdv{\hat{\rho}}{T} & \textrm{coefficient de dilatation thermique } \Big[\si{\frac{m^3}{K}}\Big],\\
    \gamma &= \hat{\gamma}(p,T) = \frac{1}{\hat{\rho}} \pdv{\rho}{p} & \textrm{coefficient de compressibilité } \Big[\si{\recip{Pa}}\Big],\\
